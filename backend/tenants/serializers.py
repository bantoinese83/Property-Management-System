...
class TenantSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'emergency_contact_relationship', 'employer_name', 'employer_phone',
            'annual_income', 'previous_landlord_name', 'previous_landlord_phone',
            'is_active', 'credit_score', 'active_lease_count', 'monthly_rent_total',
            'created_at', 'updated_at'
        ]
        read_only_fields = ['id', 'created_at', 'updated_at', 'active_lease_count', 'monthly_rent_total']

...
from core.permissions import IsMaintenanceRelatedParty
...
class MaintenanceRequestViewSet(viewsets.ModelViewSet):
    ...
    @action(detail=False, methods=['get'], url_path='by_priority/(?P<priority>\w+)')
    ...
    def assign(self, request, pk=None):
        ...
        if (maintenance_request.property.owner != request.user and

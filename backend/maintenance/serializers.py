...
class MaintenanceRequestSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'assigned_to', 'assigned_to_name', 'vendor_name', 'vendor_phone', 'vendor_email',
            'estimated_cost', 'actual_cost', 'requested_date', 'scheduled_date', 'completed_date',
            'images', 'notes', 'is_overdue', 'days_since_request',
            'created_at', 'updated_at'
        ]
        read_only_fields = [
            'id', 'created_at', 'updated_at', 'is_overdue', 'days_since_request'
        ]

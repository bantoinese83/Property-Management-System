...
class DocumentService:
    ...
    def validate_template(content: str) -> Dict[str, Any]:
        ...
        variables = DocumentService.extract_variables(content)
    ...
    def generate_document(
        ...
        # Render the document
        rendered_content = DocumentService.render_template(template.content, variables)
...
If you have any questions about this notice or the move-out process, please contact us immediately.
...
""",
        ...
        for template_data in templates_data:
            ...
            if created:
                ...
                variables = DocumentService.extract_variables(template.content)

...
class FinancialTransactionSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'id', 'property', 'property_name', 'transaction_type', 'category', 'amount',
            'description', 'transaction_date', 'lease', 'maintenance_request',
            'vendor_name', 'vendor_invoice_number', 'recorded_by', 'recorded_by_name',
...
class AccountingPeriodSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'id', 'property', 'property_name', 'period_start', 'period_end', 'period_type',
            'total_income', 'total_expenses', 'net_income', 'profit_margin',

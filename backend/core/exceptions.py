    ...
    error_logger.error(
        ...
        extra={
            "extra_data": {
                ...
                "user_id": (
                    request.user.id if request and hasattr(request, "user") and request.user.is_authenticated else None
                ),
            }
        },
        exc_info=True,
...
def validate_request_data(
    data: Dict[str, Any], required_fields: list, field_validators: Dict[str, callable] = None
) -> Dict[str, str]:
    """

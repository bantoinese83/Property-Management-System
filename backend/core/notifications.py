...
def notify_maintenance_request(request_obj):
    ...
    message = (
        f"A new maintenance request has been submitted for {request_obj.property_obj.property_name}.\n\n"
...
def notify_payment_received(payment_obj):
    ...
    message = (
        f"A payment has been received for {payment_obj.lease_obj.property_obj.property_name}.\n\n"
...
def notify_maintenance_status_change(request_obj):
    ...
    message = (
        f"The status of your maintenance request for {request_obj.property_obj.property_name} has been updated.\n\n"
...
def notify_lease_expiry(lease_obj):
    ...
    message = (
        f"The lease for {lease_obj.property_obj.property_name} is set to expire on {lease_obj.lease_end_date}.\n\n"
...
def notify_lease_created(lease_obj):
    ...
    message = (
        f"A new lease agreement has been created for you at {lease_obj.property_obj.property_name}.\n\n"
...
def notify_payment_overdue(payment_obj):
    ...
    message = (
        f"Your rent payment for {payment_obj.lease_obj.property_obj.property_name} is overdue.\n\n"
...
def notify_rent_due(payment_obj):
    ...
    message = (
        f"This is a reminder that your rent for {payment_obj.lease_obj.property_obj.property_name} is due on {payment_obj.due_date}.\n\n"
        f"Amount: {payment_obj.amount}\n\n"

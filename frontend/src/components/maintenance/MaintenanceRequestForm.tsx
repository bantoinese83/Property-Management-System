...
type MaintenanceRequestFormValues = Omit<
  MaintenanceRequest,
  'id' | 'tenant_name' | 'property_name' | 'requested_by_name' | 'assigned_to_name' | 'created_at' | 'updated_at' | 'is_overdue' | 'days_since_request'
>
    ...
    <form onSubmit={handleSubmit} className="space-y-5">
      ...
      <div className="space-y-3">
        <div>
          ...
          <p className="text-xs text-muted-foreground">Basic information about the maintenance request</p>
        </div>
      ...
      <div className="space-y-3">
        <div>
          ...
          <p className="text-xs text-muted-foreground">Assign the request to a maintenance person</p>
        </div>

...
const PropertiesPage: React.FC = () => {
  ...
  return (
    <div className="properties-page">
          ...
          >
            <div className="property-info">
              <div className="property-details">
                ...
                <span className={`occupancy-rate ${property.occupancy_rate > 80 ? 'high' : property.occupancy_rate > 50 ? 'medium' : 'low'}`}>
                  {property.occupancy_rate}% occupied
                </span>
              </div>
              <div className="property-financial">
                <div className="monthly-income">
                  ${property.monthly_income}/month
                </div>
              </div>
            </div>
      ...
      >
        {editingProperty && (
          <PropertyForm property={editingProperty} onClose={handleCloseModal} />
        )}
      </Modal>
    </div>
  );

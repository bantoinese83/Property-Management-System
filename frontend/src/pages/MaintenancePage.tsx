...
const MaintenancePage: React.FC = () => {
  ...
  return (
    ...
    >
            ...
            <div className='rounded-lg border bg-card p-6 shadow-sm'>
              <div className='flex items-center justify-between'>
                <div>
                  ...
                  <p className='text-2xl font-bold tabular-nums lg:text-3xl'>{requests.length}</p>
                </div>
                ...
                <Card key={request.id} className='p-6'>
                  <div className='flex items-start justify-between'>
                    <div className='space-y-1'>
                      <h3 className='font-semibold leading-none tracking-tight'>{request.title}</h3>
                  ...
                  <div className='mt-6 flex gap-2'>
                    ...
                    <Button
                      ...
                      onClick={() =>
                        toast.info('Status update coming soon!', {
                          description:
                            'You will be able to update the status of maintenance requests.',
                        })
                      }
                      className='flex-1'
                    >
                    ...
                    <Button
                      ...
                      size='sm'
                      onClick={() =>
                        toast.info('Request details coming soon!', {
                          description: 'Detailed view of maintenance request will be available.',
                        })
                      }
      ...
      >
        {editingRequest && (
          <MaintenanceRequestForm request={editingRequest} onClose={handleCloseModal} />
        )}
      </Modal>
    </SidebarProvider>
  )

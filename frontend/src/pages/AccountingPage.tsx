...
import { Plus, TrendingUp, TrendingDown, DollarSign, Calculator, FileText, BarChart3 } from 'lucide-react'
      ...
      <SidebarInset>
        ...
        <div className="flex flex-1 flex-col gap-4 p-4 lg:gap-6 lg:p-6">
          ...
          <div className="flex items-center justify-between">
            ...
            <Button variant="primary" onClick={handleAddTransaction} className="flex items-center gap-2">
              ...
              transactions.map((transaction) => (
                <Card key={transaction.id} className="p-6">
                  <div className="flex items-start justify-between">
                    ...
                    <Badge variant={getTransactionTypeVariant(transaction.transaction_type)} className="text-xs">
